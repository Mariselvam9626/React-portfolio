  ...
  return (
    <article  className='flex flex-col md:flex-row px-5 py-32 bg-gradient-to-r from-sky-500 to-indigo-500 justify-center'>
        <div className='md:w-1/2 flex flex-col'>
            <h1 className=' text-white text-6xl font-hero-font' >Hii,<br /> Im <span className='text-black'> Mariselvam</span>
            <p className='text-2xl '>Im a Junior Software Developer</p>
            </h1>
            <div className='flex py-10 '>
                <a href={config.Twitter} className='pr-5 hover:text-white'><AiOutlineX size={40} /></a>
                ...
                <a href={config.Instagram} className='pr-5  hover:text-white'><SlSocialInstagram size={40} /></a>
            </div>
        </div>  
    <img className='md:w-1/3 rounded-full h-[450px] border-2 border-black' src={heropng} alt='image' />
